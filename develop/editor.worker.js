...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return setImmediate; });
...
var winjs_base = __webpack_require__(0);
...
var async_Delayer = /** @class */ (function () {
    ...
    Delayer.prototype.trigger = function (task, delay) {
        ...
        if (!this.completionPromise) {
            this.completionPromise = new winjs_base["b" /* TPromise */](function (c, e) {
                _this.doResolve = c;
                _this.doReject = e;
            }).then(function () {
...
// CONCATENATED MODULE: ./node_modules/monaco-editor/esm/vs/base/common/winjs.polyfill.promise.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
 ...
 * and native promises.
 */
var winjs_polyfill_promise_PolyfillPromise = /** @class */ (function () {
    function PolyfillPromise(initOrPromise) {
        if (isWinJSPromise(initOrPromise)) {
            this._winjsPromise = initOrPromise;
        }
        else {
            this._winjsPromise = new winjs_base["a" /* Promise */](function (resolve, reject) {
                ...
                initOrPromise(function (value) {
                    if (!initializing) {
                        ...
                        platform["d" /* setImmediate */](function () { return resolve(value); });
                    }
                }, function (err) {
                    if (!initializing) {
                        reject(err);
                        ...
                        platform["d" /* setImmediate */](function () { return reject(err); });
                    }
                });
                initializing = false;
            });
    ...
    PolyfillPromise.all = function (thenables) {
        return new PolyfillPromise(winjs_base["a" /* Promise */].join(thenables).then(null, function (values) {
    ...
    PolyfillPromise.race = function (thenables) {
        ...
        return new PolyfillPromise(winjs_base["a" /* Promise */].any(thenables).then(function (entry) { return entry.value; }, function (err) { return err.value; }));
    };
    PolyfillPromise.resolve = function (value) {
        return new PolyfillPromise(winjs_base["a" /* Promise */].wrap(value));
    };
    PolyfillPromise.reject = function (value) {
        return new PolyfillPromise(winjs_base["a" /* Promise */].wrapError(value));
    };
    PolyfillPromise.prototype.then = function (onFulfilled, onRejected) {
        ...
        var promise = new PolyfillPromise(this._winjsPromise.then(onFulfilled && function (value) {
            if (!sync) {
                ...
                return new winjs_base["a" /* Promise */](function (resolve, reject) {
                    platform["d" /* setImmediate */](function () {
                        var result;
                        try {
...
if (typeof global.Promise === 'undefined') {
    global.Promise = winjs_polyfill_promise_PolyfillPromise;
}
...
function arrays_first(array, fn, notFoundValue) {
